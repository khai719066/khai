# -*- encoding: utf-8 -*-
# stub: mime-types-data 3.2026.0701 ruby lib

Gem::Specification.new do |s|
  s.name = "mime-types-data".freeze
  s.version = "3.2026.0701"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<hoe-halostatue>.freeze, ["~> 3.0"])
      ...
      s.add_dependency(%q<hoe-halostatue>.freeze, ["~> 3.0"])
